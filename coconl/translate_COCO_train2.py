...
translated_train_coco_file = "captions_train2017_NL2.json"
...
train_captions_subset = train_captions['annotations'][247164:534469]
...
with open('train_cap_img_ids2.json', 'w') as f:
