...
# HERE WE OBTAIN MASKS, MASKED IMAGE FEATURES OF ALIGNED FIXATION WINDOWS
...
def get_masked_image_features(img_id, fixations, model, duration_weighted, img_transform):
    ...
    #image.save('check' + str(count) + '.png')
...
ppn_subset = ['106', '29', '101', '16', '50', '17', '5', '103', '38']
...
for ppn in ppn_subset:
    ...
    for img_id in alignments[ppn]:
        ...
        for alg in single_alignment:
            ...
            masked_img_features = get_masked_image_features(img_id, fixations, resnet101, duration_weighted, img_transform)
